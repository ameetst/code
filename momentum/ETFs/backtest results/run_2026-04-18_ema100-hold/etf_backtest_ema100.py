...
class CONFIG:
    ...
    OUT_DIR          = r"C:\Users\ameet\Documents\Github\code\momentum\ETFs\backtest results\run_2026-04-18_ema100-hold"
    ...
    TREND_FAST_EMA   = 50
    TREND_SLOW_EMA   = 100           # KEY DIFFERENCE: 200 vs 100 in Run 1
...
def run_backtest() -> dict:
    ...
    print("\n" + "="*50)
    print("  NEW APPROACH: EMA100-HOLD | 10% TSL (Mon) | 6% Cash")
    print("="*50)
    ...
    ax.plot(res["equity"], label="New Approach (EMA100-HOLD, 10% TSL Mon, 6% cash)",
    ...
    ax.set_title("New Approach: EMA100-HOLD Regime | 10% TSL (Weekly) | 6% Cash | Monthly Rebalance")
