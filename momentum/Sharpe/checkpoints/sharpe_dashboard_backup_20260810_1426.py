...
def compute_weights(result, dynamic_n, capital_val, max_position_size_inr_val):
    ...
    for t in raw_w:
        ...
        raw_alloc    = nw * capital_val
        capped_alloc = min(raw_alloc, max_position_size_inr_val)
        weights[t]   = capped_alloc / capital_val if capital_val > 0 else 0.0
...
weights, cash_wt = compute_weights(result, dynamic_n, capital, max_position_size_inr)
