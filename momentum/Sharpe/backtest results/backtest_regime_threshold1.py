...
print(f"\nStarting Point-in-Time Vectorised Backtest (Momentum breadth threshold = {MOMENTUM_THRESHOLD}):")
print("-" * 80)
...
run_dir = os.path.join(os.path.dirname(os.path.abspath(__file__)), f"run_regime_thresh1_{timestamp}")
...
print(f"\n=== PERFORMANCE SUMMARY (Momentum breadth threshold = {MOMENTUM_THRESHOLD}) ===")
