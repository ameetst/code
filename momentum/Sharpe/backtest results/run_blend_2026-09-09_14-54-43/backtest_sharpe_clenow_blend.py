...
print("\nStarting Point-in-Time Vectorised Backtest (Sharpe/Clenow 50-50 blend):")
print("-" * 80)
...
run_dir = os.path.join(os.path.dirname(os.path.abspath(__file__)), f"run_blend_{timestamp}")
...
print("\n=== PERFORMANCE SUMMARY (50% Sharpe COMPOSITE / 50% Clenow) ===")
...
try:
    ...
    plt.title('50% Sharpe COMPOSITE / 50% Clenow Blend vs NIFTY500\n(Red shading = CASH Regime)')
    plt.xlabel('Date')
