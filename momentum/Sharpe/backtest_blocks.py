...
def compute_block_sharpe(sliced_prices, stock_tickers):
    num_days = 63
...
for i in range(len(valid_dates) - 1):
    ...
    with suppress_stdout():
        _, z_df = compute_block_sharpe(sliced_prices, stock_tickers)
    ...
    # COMPOSITE = equal weight of the 4 individual blocks
