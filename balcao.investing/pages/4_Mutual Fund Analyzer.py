...
ranking_methodology_options = ["Select an Option", "Year-On-Year Consistency Rank", "# of Years Consistency Rank"]
...
if selected_fund_type != "Select an Option" and ranking_methodology != "Select an Option":
